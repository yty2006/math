...
function() {
	...
	function s(e, n) {
		...
		Docsify.dom.toggleClass(o, "search"),
		Docsify.dom.before(i, o)
	}
	function c(e) {
		var n = Docsify.dom.find("div.search"),
		t = Docsify.dom.find(n, ".results-panel");
		if (!e) return t.classList.remove("show"),
		void(t.innerHTML = "");
		var o = i(e),
		r = "";
	...
	function l() {
		...
		Docsify.dom.on(n, "click",
		function(e) {
			return "A" !== e.target.tagName && e.stopPropagation()
		}),
		Docsify.dom.on(t, "input",
		function(n) {
			clearTimeout(e),
	...
	function f(e, n) {
		...
		if (t) if ("string" == typeof e) t.placeholder = e;
		else {
	...
	function u(e, n) {
		f(e.placeholder, n.route.path),
		d(e.noData, n.route.path)
	}
	var h, g = {},
	y = "",
	m = {
